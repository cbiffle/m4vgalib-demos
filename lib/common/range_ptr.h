#ifndef LIB_COMMON_RANGE_PTR_H
#define LIB_COMMON_RANGE_PTR_H
...
//                                    "void.");
   ...
   */
  constexpr inline IMPLICIT operator RangePtr<E const>() const {
